...
func (app *application) CheckS(P string) (bool, error) {

	if app.Key != app.config.KEY {
		return false, errors.New("the app couldn't start properly, please contact the developer")
	}
...
func (app *application) GenerateOrderNumber() (string, error) {
